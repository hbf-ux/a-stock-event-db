...
function RadarPanel({ events, feedEvents, announcements, stats, runs, onProfile }: { events: EventRow[]; feedEvents: EventRow[]; announcements: AnnouncementRow[]; stats: StatsData; runs: SyncRun[]; onProfile: (stock: string) => void }) {
...
export default function Home() {
  const [view, setView] = useState<"dashboard" | "announcements" | "events" | "reviews" | "logs">("dashboard");
  ...
  return <main className="shell">
    ...
    <section className="content">
      ...
      <div className="page">
        ...
        {view === "dashboard" ? <RadarPanel events={events} feedEvents={feedEvents} announcements={announcements} stats={statsData} runs={syncRuns} onProfile={(stock) => void openProfile(stock)} /> : view === "reviews" ? <ReviewPanel reviews={reviews} onOpen={openReview} onReprocess={() => void reprocessReviews()} reprocessing={reprocessing} /> : view === "logs" ? <LogsPanel runs={syncRuns} /> : <section className="panel">
