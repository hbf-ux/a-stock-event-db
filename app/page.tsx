...
export default function Home() {
  const [view, setView] = useState<"dashboard" | "watchlist" | "announcements" | "events" | "reviews" | "logs">("dashboard");
  ...
  const pageTitle = view === "dashboard" ? "质押雷达" : view === "watchlist" ? "我的关注" : view === "announcements" ? "公告中心" : view === "reviews" ? "人工审核" : view === "logs" ? "系统日志" : "股权质押";
