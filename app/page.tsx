  ...
  return <main className="shell">
    ...
    <section className="content">
      ...
      <div className="page">
        ...
        {view === "dashboard" ? <><RiskBrief events={events} feedEvents={feedEvents} announcements={announcements} runs={syncRuns} /><RadarPanel events={events} feedEvents={feedEvents} announcements={announcements} stats={statsData} runs={syncRuns} onProfile={(stock) => void openProfile(stock)} watchlist={watchlist} onToggleWatch={toggleWatch} /><ResearchPanel events={events} onProfile={(stock) => void openProfile(stock)} /><ShareholderHistoryPanel events={events} /></> : view === "watchlist" ? <WatchlistPanel events={events} watchlist={watchlist} onProfile={(stock) => void openProfile(stock)} onToggleWatch={toggleWatch} /> : view === "alerts" ? <AlertsPanel feedEvents={feedEvents} watchlist={watchlist} onProfile={(stock) => void openProfile(stock)} /> : view === "research" ? <><ResearchPanel events={events} onProfile={(stock) => void openProfile(stock)} /><ShareholderHistoryPanel events={events} /></> : view === "reviews" ? <ReviewPanel reviews={reviews} onOpen={openReview} onReprocess={() => void reprocessReviews()} reprocessing={reprocessing} /> : view === "logs" ? <LogsPanel runs={syncRuns} /> : <section className="panel">
