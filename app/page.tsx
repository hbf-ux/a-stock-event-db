...
function RadarPanel({ events, feedEvents, announcements, stats, runs }: { events: EventRow[]; feedEvents: EventRow[]; announcements: AnnouncementRow[]; stats: StatsData; runs: SyncRun[] }) {
  ...
  return <main className="shell">
    ...
    <section className="content">
      ...
      <div className="page">
        ...
        {view === "dashboard" ? <RadarPanel events={events} feedEvents={feedEvents} announcements={announcements} stats={statsData} runs={syncRuns} /> : view === "reviews" ? <ReviewPanel reviews={reviews} onOpen={openReview} onReprocess={() => void reprocessReviews()} reprocessing={reprocessing} /> : view === "logs" ? <LogsPanel runs={syncRuns} /> : <section className="panel">
