...
function RadarPanel({ events, announcements, stats, runs }: { events: EventRow[]; announcements: AnnouncementRow[]; stats: StatsData; runs: SyncRun[] }) {
  ...
  return <main className="shell">
    ...
    <section className="content">
      ...
      <div className="page">
        ...
        {view === "dashboard" ? <RadarPanel events={events} announcements={announcements} stats={statsData} runs={syncRuns} /> : view === "reviews" ? <ReviewPanel reviews={reviews} onOpen={openReview} onReprocess={() => void reprocessReviews()} reprocessing={reprocessing} /> : view === "logs" ? <LogsPanel runs={syncRuns} /> : <section className="panel">
