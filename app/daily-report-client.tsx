...
export default function DailyReportClient({requestedDate}:{requestedDate?:string}){
  ...
  const downloadImage=()=>{
    ...
    ctx.fillStyle="#fff";ctx.font="700 32px sans-serif";ctx.fillText("HBF · A股质押日报",70,70);ctx.font="700 62px sans-serif";ctx.fillText(report.date,70,155);ctx.font="24px sans-serif";ctx.fillStyle="#b9c9e4";ctx.fillText(`20:00截止｜三所交叉核验｜${report.status==="provisional"?"临时版·仍有未决公告":"正式关账口径"}`,70,205);
